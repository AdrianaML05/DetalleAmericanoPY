...
{
    public partial class frmRCompra : Form
    {
        ...
        private void frmRCompra_Load(object sender, EventArgs e)
        {
        ...
        private void InicializarReporteVacio()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(rutaReporte))
                {
                    ...
                    ReportDataSource rds = new ReportDataSource("RPCompra", dtVacio);
        ...
        private DataTable CrearEstructuraVacia()
        {
            ...
            dt.Columns.Add("TotalCompra", typeof(decimal));
            dt.Columns.Add("Estatus", typeof(string));
            dt.Columns.Add("FechaCancelacion", typeof(DateTime));
            dt.Columns.Add("MotivoCancelacion", typeof(string));
            dt.Columns.Add("UsuarioCancelo", typeof(int));
            dt.Columns.Add("idProveedores", typeof(int));
        ...
        private DataTable ObtenerDatosCompras()
        {
            DataTable dt = new DataTable();

            // Consulta con las columnas que existen en vw_Compras
            string query = @"SELECT 
           idCompra, 
        Folio, 
   Fecha, 
     ...
     FROM dbo.vw_Compras";
        ...
        private void CargarReporte(string folio, DateTime? fechaInicio, DateTime? fechaFin, bool todos)
        {
            try
            {
                ...
                DataTable datosCompletos = ObtenerDatosCompras();
                ...
                if (string.IsNullOrEmpty(rutaReporte))
                {
                    MessageBox.Show("No se encontró el archivo del reporte RP_Compra.rdlc",
             "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                ReportDataSource rds = new ReportDataSource("RPCompra", datosFiltrados);
                rvVenta.LocalReport.DataSources.Add(rds);
        ...
        private string BuscarRutaReporte()
        {
           ...
           {
              System.IO.Path.Combine(Application.StartupPath, "RP_Compra.rdlc"),
     System.IO.Path.Combine(Application.StartupPath, @"Reportes\RP_Compra.rdlc"),
      System.IO.Path.Combine(Application.StartupPath, @"..\..\..\CapaNegocio\Reportes\RP_Compra.rdlc"),
    System.IO.Path.Combine(Application.StartupPath, @"..\..\..\..\CapaNegocio\Reportes\RP_Compra.rdlc"),
   @"D:\DetalleAmericano2.1\CapaNegocio\Reportes\RP_Compra.rdlc"
            };
