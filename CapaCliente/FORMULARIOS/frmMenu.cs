...
namespace CapaCliente.FORMULARIOS
{
  ...
  // Agregar el evento del botón de reportes
      RVENTA.Click += RVENTA_Click;
        }
...
private void button5_Click(object sender, EventArgs e)
 ...
 abrirformulario(new frmPaqueteria());
        ...
        private void RVENTA_Click(object sender, EventArgs e)
        {
   // Abrir el mini menú de reportes pasándole el panel principal
            Reportes menuReportes = new Reportes(this.Abrirform);
       menuReportes.StartPosition = FormStartPosition.CenterScreen;
